      ...
      000003 02 00 74         [24]  301 	ljmp	_main
                                    ...
                                    309 ;------------------------------------------------------------
                                    310 ;n                         Allocated to registers 
                                    311 ;------------------------------------------------------------
                                    312 ;	seperate_key.c:6: void delay(int n) {
                                    313 ;	-----------------------------------------
                                    314 ;	 function delay
                                    315 ;	-----------------------------------------
      000062                        316 _delay:
      ...
      000071 70 F3            [24]  337 	jnz	00101$
                                    338 ;	seperate_key.c:8: }
      000073 22               [24]  339 	ret
                                    340 ;------------------------------------------------------------
                                    341 ;Allocation info for local variables in function 'main'
                                    342 ;------------------------------------------------------------
                                    343 ;	seperate_key.c:10: int main(void) {
                                    344 ;	-----------------------------------------
                                    345 ;	 function main
                                    346 ;	-----------------------------------------
      000074                        347 _main:
                                    348 ;	seperate_key.c:11: led2 = 0;
                                    349 ;	assignBit
      000074 C2 A1            [12]  350 	clr	_P2_1
                                    351 ;	seperate_key.c:12: delay(100000);
      000076 90 86 A0         [24]  352 	mov	dptr,#0x86a0
      000079 12 00 62         [24]  353 	lcall	_delay
                                    354 ;	seperate_key.c:13: led2 = 1;
                                    355 ;	assignBit
      00007C D2 A1            [12]  356 	setb	_P2_1
                                    357 ;	seperate_key.c:14: delay(100000);
      00007E 90 86 A0         [24]  358 	mov	dptr,#0x86a0
      000081 12 00 62         [24]  359 	lcall	_delay
                                    360 ;	seperate_key.c:15: return 0;
      000084 90 00 00         [24]  361 	mov	dptr,#0x0000
                                    362 ;	seperate_key.c:16: }
      000087 22               [24]  363 	ret
                                    364 	.area CSEG    (CODE)
                                    365 	.area CONST   (CODE)
                                    366 	.area XINIT   (CODE)
